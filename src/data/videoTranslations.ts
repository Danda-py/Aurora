...
export const VIDEO_TRANSLATIONS: Record<Language, VideoTranslationSchema> = {
  it: {
    ...
    checkInPage: {
      ...
      inPersonWelcome: "Accoglienza di persona dal vostro host Nino",
  ...
  en: {
    ...
    checkInPage: {
      ...
      inPersonWelcome: "In-person welcome from your host Nino",
  ...
  de: {
    ...
    checkInPage: {
      ...
      inPersonWelcome: "Persönlicher Empfang durch Ihren Gastgeber Nino",
  ...
  fr: {
    ...
    checkInPage: {
      ...
      inPersonWelcome: "Accueil en personne par votre hôte Nino",
  ...
  es: {
    ...
    checkInPage: {
      ...
      inPersonWelcome: "Bienvenida en persona de tu anfitrión Nino",
