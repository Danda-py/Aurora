...
export const BOOK_DATA: Record<Language, {
  ...
  it: {
    ...
    contacts: {
      ...
      rateWebsite: "VALUTA SU BEDANDBREAKFAST.IT",
  ...
  en: {
    ...
    contacts: {
      ...
      rateWebsite: "REVIEW ON BEDANDBREAKFAST.IT",
  ...
  fr: {
    ...
    contacts: {
      ...
      rateWebsite: "NOTER SUR BEDANDBREAKFAST.IT",
  ...
  es: {
    ...
    contacts: {
      ...
      rateWebsite: "VALORAR EN BEDANDBREAKFAST.IT",
  ...
  de: {
    ...
    contacts: {
      ...
      rateWebsite: "AUF BEDANDBREAKFAST.IT BEWERTEN",
