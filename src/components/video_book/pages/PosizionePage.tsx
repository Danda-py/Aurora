...
export const PosizionePage: React.FC<Props> = ({ language, onBackToMenu, onSelectLanguage }) => {
  ...
  return (
    <div className="bg-[#0b0e14] min-h-full rounded-none sm:rounded-3xl p-4 sm:p-6 text-slate-100 space-y-4 pb-24">
      ...
      <div className="relative h-48 sm:h-56 w-full rounded-2xl overflow-hidden shadow-sm border border-white/[0.08]">
        <iframe
      ...
      <div className="p-4 sm:p-5 rounded-2xl bg-[#141824] border border-white/[0.08] shadow-sm space-y-3">
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-start gap-2.5 min-w-0">
            <div className="w-8 h-8 rounded-full bg-white/[0.08] border border-white/10 flex items-center justify-center text-neutral-200 shrink-0 mt-0.5">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-full py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs transition shadow-xs flex items-center justify-center gap-2 cursor-pointer"
        >
