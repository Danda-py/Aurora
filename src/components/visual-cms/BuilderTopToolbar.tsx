...
import { Check, Loader2, AlertCircle, Languages, Save } from 'lucide-react';
...
export const BuilderTopToolbar: React.FC<{ className?: string }> = ({ className = '' }) => {
  ...
  const { saveStatus: editSaveStatus, saveNow, currentLanguage, setLanguage: setEditLanguage } = useEditMode();
